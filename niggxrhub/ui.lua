...
if debugX then
	warn('Initialising Nigger Hub UI')
end
...
local settingsTable = {
	General = {
		...
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'Nigger Menu Keybind'},
		-- buildwarnings
		-- rayfieldprompts
...
if promptUser == 1 and prompt and type(prompt.create) == "function" then
	prompt.create(
		'Hello nigger',
	    [[This was a rayfield alert, but we removed it.

<font transparency='0.3'>Just press ok faggot</font>]],
		'Okay nigga',
		'',
		function()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "Nigger Hub 📜"
	end
